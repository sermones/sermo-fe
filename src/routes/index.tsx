...
function RouteComponent() {
  ...
  const getInstallButtonClass = () => {
    const baseClass = "inline-flex items-center px-4 py-2 font-semibold rounded-lg transition-all shadow-lg transform hover:scale-105 text-sm";
            ...
            <div className="bg-white rounded-lg shadow-md p-4">
              ...
              <div className="space-y-3">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h3 className="font-medium text-sm text-gray-800">📴 오프라인 지원</h3>
                ...
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-blue-500 rounded-full mt-2"></div>
                  <div>
                    <h3 className="font-medium text-sm text-gray-800">📱 홈 화면 설치</h3>
                    <p className="text-gray-600 text-xs">
                ...
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-blue-500 rounded-full mt-2"></div>
                  <div>
                    <h3 className="font-medium text-sm text-gray-800">🚀 네이티브 앱 경험</h3>
                    <p className="text-gray-600 text-xs">
                      브라우저 없이 독립적으로 실행됩니다
                    </p>
                  </div>
                ...
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-blue-500 rounded-full mt-2"></div>
                  <div>
                    <h3 className="font-medium text-sm text-gray-800">⚡ 빠른 로딩</h3>
                    <p className="text-gray-600 text-xs">
                      캐싱을 통해 더 빠르게 로드됩니다
                    </p>
                  </div>
